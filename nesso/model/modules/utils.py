...
def randomly_rotate(
    coords, return_second_coords=False, second_coords=None, generator=None
):
...
def center_random_augmentation(
    ...
    if augmentation:
        ...
        # randn_like() takes no generator; empty_like().normal_() is equivalent.
        trans_shape = atom_coords[:, 0:1, :]
        random_trans = torch.empty_like(trans_shape).normal_(generator=generator)
        random_trans = random_trans * s_trans
